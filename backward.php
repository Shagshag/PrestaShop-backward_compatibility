...
else if (isset($this->context))
{
	...
	if (version_compare(_PS_VERSION_, '1.5.0.0', '>=') && isset($this->context->employee->id) && $this->context->employee->id && isset(AdminController::$currentIndex) && !empty(AdminController::$currentIndex))
	{
		global $currentIndex;
